export * from '../models/Examplev1ExampleRequest';
export * from '../models/Examplev1ExampleResponse';
...
let typeMap: {[index: string]: any} = {
    "Examplev1ExampleRequest": Examplev1ExampleRequest,
    "Examplev1ExampleResponse": Examplev1ExampleResponse,
