export * from '../models/Examplev2ExampleRequest';
export * from '../models/Examplev2ExampleResponse';
...
let typeMap: {[index: string]: any} = {
    "Examplev2ExampleRequest": Examplev2ExampleRequest,
    "Examplev2ExampleResponse": Examplev2ExampleResponse,
