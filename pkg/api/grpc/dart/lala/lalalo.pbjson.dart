...
const $core.Map<$core.String, $core.dynamic> ExampleServiceBase$json = {
  '1': 'ExampleService',
  '2': [
    {'1': 'Example', '2': '.api.lala.ExampleRequest', '3': '.api.lala.ExampleResponse', '4': {}},
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> ExampleServiceBase$messageJson = {
  '.api.lala.ExampleRequest': ExampleRequest$json,
  '.api.lala.ExampleResponse': ExampleResponse$json,
};
...
final $typed_data.Uint8List exampleServiceDescriptor = $convert.base64Decode(
    'Cg5FeGFtcGxlU2VydmljZRKEAQoHRXhhbXBsZRIYLmFwaS5sYWxhLkV4YW1wbGVSZXF1ZXN0Gh'
    'kuYXBpLmxhbGEuRXhhbXBsZVJlc3BvbnNlIkSSQSUSEUNyZWF0ZSBhbiBleGFtcGxlYhAKDgoK'
    'QmVhcmVyQXV0aBIAgtPkkwIWIhEvZ3JwYy9hcGkvZXhhbXBsZToBKg==');
