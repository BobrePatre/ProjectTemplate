export * from '../models/ApilalaExampleRequest';
export * from '../models/ApilalaExampleResponse';
...
let typeMap: {[index: string]: any} = {
    "ApilalaExampleRequest": ApilalaExampleRequest,
    "ApilalaExampleResponse": ApilalaExampleResponse,
