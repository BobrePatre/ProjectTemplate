 ...
 * 
 * @export
 * @interface ApilalaExampleRequest
 */
export interface ApilalaExampleRequest {
    /**
     * 
     * @type {string}
     * @memberof ApilalaExampleRequest
     */
    'title'?: string;
    /**
     * 
 ...
 * 
 * @export
 * @interface ApilalaExampleResponse
 */
export interface ApilalaExampleResponse {
    /**
     * 
     * @type {string}
     * @memberof ApilalaExampleResponse
     */
    'title'?: string;
    /**
     * 
...
export const ExampleServiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {ApilalaExampleRequest} body 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        exampleServiceExample: async (body: ApilalaExampleRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ExampleServiceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async exampleServiceExample(body: ApilalaExampleRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApilalaExampleResponse>> {
...
export const ExampleServiceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        exampleServiceExample(body: ApilalaExampleRequest, options?: any): AxiosPromise<ApilalaExampleResponse> {
...
export class ExampleServiceApi extends BaseAPI {
     ...
     */
    public exampleServiceExample(body: ApilalaExampleRequest, options?: RawAxiosRequestConfig) {
