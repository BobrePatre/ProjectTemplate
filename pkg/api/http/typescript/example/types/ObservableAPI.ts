...
export class ObservableExampleServiceApi {
     ...
     * @param body 
     */
    public exampleServiceExampleWithHttpInfo(body: ApiexampleExampleRequest, _options?: Configuration): Observable<HttpInfo<ApiexampleExampleResponse>> {
     ...
     * @param body 
     */
    public exampleServiceExample(body: ApiexampleExampleRequest, _options?: Configuration): Observable<ApiexampleExampleResponse> {
        return this.exampleServiceExampleWithHttpInfo(body, _options).pipe(map((apiResponse: HttpInfo<ApiexampleExampleResponse>) => apiResponse.data));
    }
