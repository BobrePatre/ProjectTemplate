...
func (r ApiExampleServiceExampleRequest) Body(body ApilalaExampleRequest) ApiExampleServiceExampleRequest {
	r.body = &body
	return r
}

func (r ApiExampleServiceExampleRequest) Execute() (*ApilalaExampleResponse, *http.Response, error) {
...
//  @return ApilalaExampleResponse
func (a *ExampleServiceAPIService) ExampleServiceExampleExecute(r ApiExampleServiceExampleRequest) (*ApilalaExampleResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ApilalaExampleResponse
	)
